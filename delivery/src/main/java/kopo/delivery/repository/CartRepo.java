...
public interface CartRepo extends JpaRepository<Cart, Long> {
    ...
    @Query("SELECT c.menu.id, c.menu.menuName, c.menu.menuAmount, count(c), c.menu.store.storeID " +
            "FROM Cart c Where c.user = :user GROUP BY c.menu")
    List<Object[]> countCartMenu(@Param("user") User user);
